              ...
              <form class="form">
                ...
                <div class="form-group">
                  ...
                  <div class="site_logo clearfix">
                    <div class="preview pull-left" v-bind:style="{background:'url('+configure.siteLogo+') no-repeat','background-size': '348px 60px'}"></div>
                ...
                <div class="form-group">
                  ...
                  <div class="site_icon clearfix">
                    <div class="preview pull-left" v-bind:style="{background:'url('+configure.siteIcon+') no-repeat','background-size': '78px 78px'}"></div>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        configure: {},
        preview_bg: require('../../assets/images/upload.png')
      }
    },
    created () {
      $self = this
    ...
    'methods': {
      ...
      'save': function () {
        ...
        $self.$http.post('/support-center/crm/configure',
          params,
          {
            headers: {
              'Content-Type': 'application/json',
