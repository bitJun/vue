  ...
  <div class="digital cantainer">
    ...
    <div class="NewOpen">
      ...
      <div class="select clearfix">
        <el-select v-model="value1" placeholder="请选择" class="addType pull-left">
          <el-option v-for="item in addtype" :key="item.value" :label="item.label" :value="item.value"></el-option>
        </el-select>
        <div class="timeselect pull-left clearfix">
          <label class="pull-left">新增时间</label>
