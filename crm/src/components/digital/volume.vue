    ...
    <div class="NewOpen">
      ...
      <div class="select clearfix">
        <div class="timeselect pull-left clearfix">
          <label class="pull-left">平仓时间</label>
      ...
      <div class="list">
        ...
        <table>
          <thead>
            <tr>
              <td v-bind:style="{width:'16%'}">账户归属</td>
              <td v-bind:style="{width:'16%'}">账户名称</td>
              <td v-bind:style="{width:'16%'}">账号</td>
              <td v-bind:style="{width:'16%'}">订单号</td>
              <td v-bind:style="{width:'14%'}">成交量(手)</td>
              <td v-bind:style="{width:'18%'}"><span>开户时间</span></td>       
            </tr>
          </thead>
          <tbody>
            <tr v-for="(item, index) in json">
              <td v-bind:style="{width:'16%'}">{{item.from}}</td>
              <td v-bind:style="{width:'16%'}">{{item.name}}</td>
              <td v-bind:style="{width:'16%'}"><p>{{item.Account}}</p></td>
              <td v-bind:style="{width:'16%'}">{{item.orderId}}</td>
              <td v-bind:style="{width:'14%'}">{{item.volume}}</td>
              <td v-bind:style="{width:'18%'}"><span>{{item.time}}</span></td>
            </tr>
          </tbody>
        </table>
