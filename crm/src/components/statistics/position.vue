      ...
      <table>
        <thead>
          <tr>
            ...
            <td v-bind:style="{width:'14%'}">类型/品种/交易量</td>
            <td v-bind:style="{width:'9%'}">开仓价</td>
            <td v-bind:style="{width:'9%'}">平仓价</td>
        ...
        <tbody>
          <tr v-for="(item, index) in json">
            ...
            <td v-bind:style="{width:'14%'}"></p>{{item.type}}/{{item.Varieties}}/{{item.volume}}</p></td>
            <td v-bind:style="{width:'9%'}"><p>{{item.Opening_price}}</p><p>{{item.open_time | time}}</p></td>
            <td v-bind:style="{width:'9%'}"><p>{{item.end_price}}</p><p>{{item.end_time | time}}</p></td>
